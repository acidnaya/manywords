...
//import UIKit
//
//protocol MoveInputDelegate {
//  func sendWasTapped(message: String)
//}
//
//class MoveInputView: UIView {
//  var delegate: MoveInputDelegate?
//  
...
//	
//	sendButton.addTarget(self, action: #selector(MoveInputView.sendTapped), for: .touchUpInside)
//	
//	addSubview(textView)
